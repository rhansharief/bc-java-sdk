...
echo
echo "Nimble Network end-to-end test"
echo
CHANNEL_NAME="$1"
DELAY="$2"
...
installChaincode () {
	...
	setGlobals $PEER
	cd $GOPATH/src
    ln -s /opt/gopath/src/github.com/hyperledger/fabric/examples/chaincode/go main
...
echo
echo "========= All GOOD, Nimble Network execution completed =========== "
echo
