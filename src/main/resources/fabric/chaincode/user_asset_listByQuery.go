...
type listUserAssetsByQueryParams struct {
	QueryString string
}

// Add list by query in case db used supports GetQueryResult
func ListUserAssetsByQuery(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	params := listUserAssetsByQueryParams{}
